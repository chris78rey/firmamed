...
import he1.uci.entities.UUlcerasXPresion;
 ...
 */
@Stateless
public class UUlcerasXPresionFacade extends AbstractFacade<UUlcerasXPresion> {
    ...
    public UUlcerasXPresionFacade() {
        super(UUlcerasXPresion.class);
    }
